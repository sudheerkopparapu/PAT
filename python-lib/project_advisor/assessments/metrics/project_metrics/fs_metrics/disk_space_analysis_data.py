...
class DiskSpaceAnalysisData(ProjectMetric):
    """
    Computes how much disk space is used by all Analysis data in a project.
    """
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config = config,
            project = project,
            name = "disk_space_analysis_data",
            metric_type = AssessmentMetricType.INT,
            description = "Disk space taken by all Analysis data in the project",
        ...
        self.folder_name= "analysis-data"
        self.uses_fs = True
        self.metric_unit = "kb"
