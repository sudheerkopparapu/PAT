...
class NumberOfDistinctVisualRecipesMetric(ProjectMetric):
    """
    Count the number of distinct visual recipes in a project.
    """
    ...
    def __init__(
        ...
        """
        Initializes the NumberOfVisualRecipesMetric metric class with the provided client, config, and project.
        """
        super().__init__(
            client=client,
            config=config,
            project=project,
            name="nbr_of_distinct_visual_recipe_types",
            metric_type=AssessmentMetricType.INT,
            description="Number of distinct visual recipes",
    ...
    def run(self) -> ProjectMetric:
        """
        Computes the number of distinct visual recipes in the project.
        :return: self
        """
        result = {}
        ...
        self.value = len(visual_recipe_distinct_types)
